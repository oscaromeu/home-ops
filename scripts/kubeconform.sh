...
echo "=== Validating kustomizations in ${KUBERNETES_DIR}/infrastructure/ ==="
find "${KUBERNETES_DIR}/infrastructure/" -type f -name $kustomize_config -print0 | while IFS= read -r -d $'\0' file;
  do
