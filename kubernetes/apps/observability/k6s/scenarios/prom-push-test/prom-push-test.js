...
//
// Queries:
//   count_over_time(k6_cronjob_runs_total{job="prom-push-test"}[1h])
//   count_over_time(k6_cronjob_runs_total{job="prom-push-test",result="failure"}[1h])
//   k6_cronjob_duration_seconds_p95{job="prom-push-test"}
//   k6_cronjob_duration_seconds_avg{job="prom-push-test"}
