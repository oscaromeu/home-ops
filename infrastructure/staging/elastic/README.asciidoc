...
[source,sh]
----
ELASTICSEARCH_PASSWORD=$(kubectl get secret elk-es-elastic-user -o=go-template='{{ .data.elastic | base64decode}}')
----
...
[source,sh]
----
curl --resolve "elastic.staging.0.0.0.0.sslip.io:443:$INGRESS_HOST" -k -u "elastic:$ELASTICSEARCH_PASSWORD" -XGET 'https://elastic.staging.0.0.0.0.sslip.io/_cat/health?v'
----
