...
| Turing Pi RK1      | 4     | **CPU** <br/>   - `8-core (Cortex-A76x4+ Cortex-A55x4)` <br/>  - `64 bit CPU` <br/>  - `@ 2.4Ghz` <br/> **GPU** `ARM Mali-G610MP4 quad-core GPU` <br/> **NPU** `AI accelerator NPU 6TOPS` <br/> **RAM** `16GB` <br/> **M.2 SSD** `500GB` <br/> https://docs.turingpi.com/docs/turing-rk1-specs-and-io-ports         | Ubuntu 22.04 LTS Server based on the BSP Linux 5.10 | Data Plane             |
...
| Unifi UDM Pro      | 1     | **CPU** `Quad-core ARM® Cortex®-A57 @ 1.7 GHz`  <br/> **System Memory** `4GB DDR4` <br/> **On-board storage**  `16 GB eMMC` <br/> **Networking interface** <br/>  - (8) LAN: `GbE RJ45 ports` <br/>  - (1) WAN: `GbE RJ45 port` <br/> **SFP+ interface** <br/>  - (1) LAN: `10G SFP+`  <br/>  - (1) WAN: `10G SFP+` | Unify OS                                            | AIO (Router+Switch+FW) |
